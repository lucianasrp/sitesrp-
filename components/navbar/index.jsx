				...
				<div className={`w-full mx-auto grid grid-cols-5 md:grid-cols-8`}>
					...
					<div className='col-span-5 
						...
						<div className='flex gap-6'>
							{/* telefone */}
							<Link href={`tel:${CONTACT.phone}`} target='_blank' rel='noreferrer'>
							...
							{/* whatsapp */}
							<Link href={`https://wa.me/${CONTACT.whatsapp.number}?text=${encodeURI(CONTACT.whatsapp.message)}`} target='_blank' rel='noreferrer'>
								<div className='flex gap-2 items-center'>
